...
notebook.add(LR1, text='LR1')
notebook.add(LR2, text='LR2')
notebook.add(LR3, text='LR3')


# Виджеты во второй вкладке
import lab1
...
codetxt = st.ScrolledText(LR3)
codetxt.place(x=40, y=0, width=410, height=370)

cpptext = st.ScrolledText(LR3)
cpptext.place(x=600, y=0, width=410, height=370)
