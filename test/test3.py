...
def is_identifier(token):
    return ((token in inverse_tokens) and re.match(r'^I\d+$', inverse_tokens[token])) or \
        token in ['in.nextInt()', 'in.nextLine()', 'System.out.print', 'System.out.println', 'public', 'static', 'void' ] or re.match(r'^М\d+$', token)
