...
SERVICE_WORDS = ['abs', 'begin', 'cos', 'do', 'downto', 'else', 'end', 'exp', \
                 'for', 'function', 'goto', 'if', 'integer', 'ln', 'of', \
                 'procedure', 'program', 'read', 'readln', 'real', 'repeat', 'sin', \
                 'sqrt', 'string', 'then', 'to', 'until', 'var', 'while', 'write', \
                 'writeln']
OPERATIONS = ['*', '+', '-', '..', '/', ':=', '<', '<=', '<>', '=', '>', '>=', \
              'and', 'div', 'mod', 'not', 'or']
SEPARATORS = ['\t', '\n', ' ', '(', ')', ',', '.', ':', ';', '[', ']']

# добавление лексемы в словарь
